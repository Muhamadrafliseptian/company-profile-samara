        ...
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-header">
                    ...
                    <a href="{{ url('/admin/solusi/solusi/create') }}" class="btn btn-primary btn-sm btn-social pull-right">
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center">Kategori Solusi</th>
                                <th>Nama Solusi</th>
                                <th>Deskripsi</th>
                        ...
                        <tbody>
                            ...
                            @foreach ($data_solusi as $data)
                                <tr>
                                    ...
                                    <td class="text-center">{{ $data->getKategoriSolusi->kategori_solusi }}</td>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <form action="{{ url('/admin/solusi/solusi/' . encrypt($data->id)) }}" method="POST"
