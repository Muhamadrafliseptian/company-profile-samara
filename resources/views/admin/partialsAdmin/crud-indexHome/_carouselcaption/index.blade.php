            ...
            <div class="card">
              ...
              <div class="card-body">
                <table class="table table-bordered table-hover example">
                  ...
                  <tr>
                    <td>{{ $carousel_caption->carousel_caption_title }}</td>
                    <td>
                      <img src="{{ asset('storage/indexHome/'.$carousel_caption->carousel_caption_img) }}" alt="{{ $carousel_caption->carousel_caption_img }}" class="img-thumbnail" width="250px">
                    </td>
                    <td>
