...
<body>
    ...
    <section id="topbar" class="d-flex align-items-center">
        <div class="container d-flex justify-content-center justify-content-md-between">
            ...
            <div class="social-links d-none d-md-flex align-items-center">
                <a href="{{ url('https://www.facebook.com/lifeatintegrasia') }}" class="twitter"><i
                        class="bi bi-twitter"></i></a>
                <a href="{{ url('https://www.facebook.com/lifeatintegrasia') }}" class="facebook"><i
                        class="bi bi-facebook"></i></a>
                <a href="{{ url('https://www.instagram.com/integrasiautama') }}" class="instagram"><i
                        class="bi bi-instagram"></i></a>
                <a href="{{ url('https://www.youtube.com/channel/UC7fpFh2NY23LH2dMuHtzHWA') }}" class="youtube"><i
                        class="bi bi-youtube"></i></a>
                <a href="{{ url('https://www.linkedin.com/company/pt-integrasia-utama') }}" class="linkedin"><i
        ...
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li class="dropdown"><a href="{{ url('blog') }}"><span>BLOG</span> <i
                                class="bi bi-chevron-down"></i></a>
                        <ul>
                            <li class="dropdown"><a href="#"><span>Event</a>
                            </li>
                            <li class="dropdown"><a href="{{ url('blog') }}"><span>Newsblog</a>
                            </li>
                            <li class="dropdown"><a href="#"><span>Press</a>
                            </li>
                            <li class="dropdown"><a href="#"><span>Lowongan Kerja</a>
                            </li>
                        </ul>
                    </li>
    ...
    {{-- <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="{{ asset("assets/img/hero-bg.jpg") }}" class="d-block" width="100%" alt="...">
                    <div class="carousel-caption text-center mb-5">
                        <h1 class="h-auto">First slide label</h1>
                        <h3 class="text-center">Some representative placeholder content for the first slide.</h3>
                    </div>
                </div>
    ...
    <section id="hero" class="d-flex align-items-center">
        <div class="container" data-aos="zoom-out" data-aos-delay="100">
            ...
            <div class="d-flex">
                ...
                <a href="{{ url('https://youtu.be/B7X4giKLQcI') }}" class="glightbox btn-watch-video"><i
        ...
        <div class="container" data-aos="zoom-in">
            ...
            <div class="row">
                <div class="col-lg-6 video-box align-self-baseline" data-aos="zoom-in" data-aos-delay="100">
                    ...
                    <a href="{{ url('https://www.youtube.com/watch?v=jDDaplaOz7Q') }}"
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
                    <div class="icon-box">
                        ...
                        <h4><a
                                href="{{ url('https://wa.me/6282299040190?text=Hello%20I%27m%20interested%20in%20OSLOG') }}">WhatsApp</a>
                        </h4>
                ...
                <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0" data-aos="zoom-in"
                    ...
                    <div class="icon-box">
                        ...
                        <h4><a href="{{ url('mailto:info@integrasiautama.com') }}">Talk with our team about our
                                product and services</a></h4>
                ...
                <div class="row" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="col-lg-6 ">
                        <iframe class="mb-4 mb-lg-0"
                            src="{{ url('https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3966.0110981970392!2d106.78601371468598!3d-6.262267595467255!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f1a206b09c8b%3A0xc34e1845b9a02a81!2sIntegrasia%20Utama!5e0!3m2!1sid!2sid!4v1656501375004!5m2!1sid!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" frameborder="0" style="border:0; width: 100%; height: 384px;') }}"
    ...
    <script src="{{ url('https://cdn.jsdelivr.net/npm/bootstrap@5.2.0-beta1/dist/js/bootstrap.bundle.min.js') }}"
