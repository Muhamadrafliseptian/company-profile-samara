                ...
                <ul>
                  ...
                  <li class="d-flex align-items-center"><i class="bi bi-chat-dots"></i> <a href="blog-single.html">12 Comments</a></li>
                            ...
                            <div class="entry-content">
                                ...
                                <p class="fs-5 lh-base">Kami menyediakan logo ini untuk mempromosikan penggunaan Anda atas
                                    produk kami dan mewakili Integrasia Utama dalam artikel berita dan posting blog.</p>
                                <p class="fs-5 lh-base">Logo Integrasia Utama harus digunakan, tidak diubah, berwarna putih
                                    dengan latar belakang gelap atau dengan latar belakang putih.</p>

                                <p class="fs-5 lh-base">Jangan gunakan merek Integrasia Utama untuk merujuk ke layanan apa
                                    pun selain Integrasia Utama.</p>
