...
<div class="container">
    ...
    <img class="img-fluid rounded mx-auto d-block"  data-aos="fade-up" src="{{ asset('assets/img/mapGIS.png') }}" alt="">
    </section>
    <br>

<section id="featured-services" class="featured-services section-bg">
        <img class="rounded mx-auto d-block w-50"  data-aos="fade-right" src="{{ asset('assets/img/uimapGIS.png') }}" alt="">
        </div>
        </section>
  <main id="main">
     <section id="featured-services" class="featured-services">
