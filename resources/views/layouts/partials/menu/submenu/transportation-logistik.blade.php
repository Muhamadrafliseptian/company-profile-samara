...
@section('transportation-logistik')
  ...
  <!-- ======= Hero Section ======= -->
  <section id="transLogis" class="d-flex align-items-center">
    <div class="container" data-aos="zoom-out" data-aos-delay="100">
      <h1 class="text-center text-light">Transportation and Logistics</h1>
    </div>
  </section>
  <br>
  <br>
...
<div class="section-title section-bg">
          <h3 class="mb-2"><span>Why We Better?</span></h3>
