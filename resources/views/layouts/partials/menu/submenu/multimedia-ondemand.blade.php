...
@section('multimedia-ondemand')


  <!-- ======= Hero Section ======= -->

  <!-- ======= Hero Section ======= -->
 <section id="multimedia-ondemand" class="d-flex align-items-center">
...
<div class="section-title">
  <h2>Description</h2>
          ...
          <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Recusandae dicta, autem blanditiis harum officiis accusamus qui repellat ipsa, adipisci dolor molestiae dolorum dolore magni magnam libero optio, fugiat cumque voluptatum.</p>
        </div>
