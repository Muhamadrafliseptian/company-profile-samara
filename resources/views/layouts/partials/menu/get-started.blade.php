  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      ...
      <div class="carousel-caption d-flex flex-column justify-content-center h-100" style="top: 0;" >
        <h5>"An open platform One Spirit ECOSystem is a bridge enabling people to integrate their system to become an Enterprise System. We can achieve it When we synergize.."</h5>
      </div>
    </div>
