...
<br>
    ...
    <section id="aboutus" class="about section">
      ...
      <div class="section-title">
        ...
        <img src="{{ asset('assets/img/milestone.png') }}" data-aos="fade-right" data-aos-delay="100" style="box-shadow: 2px 4px 50px rgb(208, 208, 208);" class="img-fluid rounded mx-auto d-block w-50" alt="...">
