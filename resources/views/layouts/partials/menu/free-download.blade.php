    ...
    <section id="services" class="services section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          ...
          <img src="{{ asset('assets/img/OSLOG-Mobile-Phone.png') }}" class="img-fluid rounded mx-auto d-block animation-button" alt="...">
...
<button class="button-71 shadow" onclick="window.location.href='#'" role="button">Download</button>
        ...
        <div class="row g-2 ">
            <div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
                <div class="member">
                    ...
                    <img src="{{ asset('assets/img/hp1.png') }}" class="img-fluid" width="500px" alt="hp2">
                    </div>
                    <div class="member-info">
                       <h4 class="text-primary">
                                OSLOG Javaz Tools: OSPOD (One Spirit Proof of Delivery)
                            </h4>
                            <p>
                        ...
                        <div class="text-center">
                            <p class=" text-info text-center"><i class="bi bi-check-lg"></i> To real-time sending the data of delivery task (job) to the mobile phone of the driver</p>
                            <p class=" text-info text-center"><i class="bi bi-check-lg"></i> Etc</p>
                        </div>
                        <div class="text-center">
                            <a href="#" class="button-72 text-light mb-2">Download</a>
                            <a href="#" class="button-71 text-light mb-2">Google Play</a>
                        </div>
                    </div>
                </div>
            </div>
           ...
           <div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
                <div class="member">
                    <div class="member-img">
                        <img src="{{ asset('assets/img/hp2.png') }}" class="img-fluid" width="500px" alt="hp2">
                    </div>
                    <div class="member-info">
                           <h4 class="text-primary">
                                OSLOG Javaz Tools: OSPOD (One Spirit Proof of Delivery)
